...
public class GradlePatcher implements GradleExecutionEnvironmentProvider {
    ...
    public ExecutionEnvironment createExecutionEnvironment(
            Project project, ExecuteRunConfigurationTask task, Executor executor) {
        ...
        return ExternalSystemUtil.createExecutionEnvironment(
                project, GradleConstants.SYSTEM_ID, settings, executorId);
    }
}
